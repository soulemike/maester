...
Active Directory computer objects have been analyzed. 0 out of 1 computers (0%) are disabled.
...
Active Directory computer objects have been analyzed. 0 out of 1 computers (0%) have SID History set.
...
- OU=Domain Controllers,DC=child,DC=misoule02,DC=local
...
| OU=Domain Controllers,DC=child,DC=misoule02,DC=local | 1 |
...
| --- | --- | --- |
| MiSouleDC03 | True | CN=MiSouleDC03,OU=Domain Controllers,DC=child,DC=misoule02,DC=local |
...
Active Directory DACL data has been analyzed. 169 distinct object(s) have one or more DACL entries available for review.

| Metric | Value |
| --- | --- |
| Total DACL Entries | 4867 |
| Distinct Objects With DACL Entries | 169 |
| Average ACEs Per Object | 28.8 |
...
| Metric | Value |
| --- | --- |
| Total DACL ACEs | 4867 |
| Distinct identities | 23 |
| Distinct objects represented | 169 |
| Identity with most ACEs | S-1-5-32-554 |
| ACEs for most represented identity | 2190 |
...
| --- | --- | --- | --- | --- |
| S-1-5-32-554 | 2190 | 158 | 0 | 0 |
| NT AUTHORITY\SELF | 661 | 158 | 0 | 0 |
| NT AUTHORITY\ENTERPRISE DOMAIN CONTROLLERS | 452 | 151 | 0 | 0 |
| NT AUTHORITY\Authenticated Users | 226 | 168 | 0 | 0 |
| CHILD\Domain Admins | 196 | 168 | 0 | 0 |
| NT AUTHORITY\SYSTEM | 175 | 168 | 0 | 0 |
| MISOULE02\Enterprise Admins | 171 | 169 | 0 | 0 |
| BUILTIN\Administrators | 166 | 160 | 0 | 0 |
| CREATOR OWNER | 156 | 156 | 0 | 0 |
| CHILD\Key Admins | 145 | 145 | 0 | 0 |
| MISOULE02\Enterprise Key Admins | 145 | 145 | 0 | 0 |
| S-1-5-32-560 | 50 | 50 | 0 | 0 |
| S-1-5-32-548 | 46 | 39 | 0 | 0 |
| S-1-5-32-561 | 30 | 15 | 0 | 0 |
| Everyone | 18 | 18 | 0 | 0 |
| CHILD\Cert Publishers | 17 | 17 | 0 | 0 |
| CHILD\RAS and IAS Servers | 9 | 3 | 0 | 0 |
| CHILD\Group Policy Creator Owners | 6 | 6 | 0 | 0 |
| BUILTIN\Print Operators | 4 | 4 | 0 | 0 |
| CHILD\Cloneable Domain Controllers | 1 | 1 | 0 | 0 |
| CHILD\Domain Controllers | 1 | 1 | 0 | 0 |
...
| Infrastructure Master | MiSouleDC03.child.misoule02.local |
| Schema Master |  |
| PDC Emulator | MiSouleDC03.child.misoule02.local |
| RID Master | MiSouleDC03.child.misoule02.local |
...
| Percentage with Unconstrained Delegation | 100% |
...
| --- | --- |
| MiSouleDC03 | Windows Server 2022 Datacenter Azure Edition |
...
| --- | --- | --- |
| Windows Server 2022 Datacenter Azure Edition | 1 | 100% |
...
| Operating System | Count | Percentage |
| --- | --- | --- |
| Windows Server 2022 Datacenter Azure Edition No Service Pack | 1 | 100% |
...
| Domain Name | child |
| Domain SID | S-1-5-21-74857073-827122270-1551711961 |
...
Cannot convert value "20260821172216.0Z" to type "System.Int32". Error: "The input string '20260821172216.0Z' was not in a correct format."
...
Active Directory groups have been analyzed. 13 out of 43 groups (30.23%) have at least one member.

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Groups with Members | 13 |
| Empty Groups | 30 |
| Groups with Members % | 30.23% |
...
Active Directory group member account types have been analyzed. Found 3 distinct account types across 9 unique members.

| Metric | Value |
| --- | --- |
| Total Unique Members Analyzed | 9 |
| Distinct Account Types | 3 |
| Account Types Found | group, foreignSecurityPrincipal, user |
...
| --- | --- | --- |
| foreignSecurityPrincipal | 4 | 44.44% |
| user | 3 | 33.33% |
| group | 2 | 22.22% |
...
| Groups Analyzed | 43 |
| Current Domain SID | S-1-5-21-74857073-827122270-1551711961 |
...
Active Directory group analysis found **22** empty non-privileged groups out of **43** total groups.
...
| --- | --- |
| Total Groups | 43 |
| Empty Non-Privileged Groups | 22 |
| Empty Privileged Groups | 8 |
| Groups with Members | 13 |
| Empty Non-Privileged Percentage | 51.16% |
...
Security audit found **2** privileged groups with members out of **10** total privileged groups.

These groups should be regularly audited for unauthorized membership changes.

| Category | Count |
| --- | --- |
| Total Privileged Groups | 10 |
| Privileged Groups with Members | 2 |
| Privileged Groups without Members | 8 |
| Well-Known Privileged with Members | 1 |
...
**Total Privileged Groups:** 10
**Total Members in Privileged Groups:** 4
...
Cannot convert value "20260821172020.0Z" to type "System.DateTime". Error: "String '20260821172020.0Z' was not recognized as a valid DateTime."
...
| GPO DisplayName | Id | GpoStatus | WmiFilter | Owner |
| --- | --- | --- | --- | --- |
| Default Domain Controllers Policy | 6ac1786c-016f-11d2-945f-00c04fb984f9 | 0 |  | CHILD\Domain Admins |
| Default Domain Policy | 31b2f340-016d-11d2-945f-00c04fb984f9 | 0 |  | CHILD\Domain Admins |
...
| --- | --- | --- |
| CHILD\Domain Admins | 2 | Default Domain Controllers Policy, Default Domain Policy |
...
Active Directory groups have been analyzed. 10 out of 43 groups (23.26%) have AdminCount set.

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Groups with AdminCount | 10 |
| AdminCount Percentage | 23.26% |
...
Active Directory groups have been analyzed. 43 out of 43 groups (100%) are located in container objects (CN=) rather than Organizational Units.

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Groups in OUs (OU=) | 0 |
| Groups in Containers (CN=) | 43 |
...
Active Directory groups have been analyzed. 0 out of 43 groups (0%) have not been modified since before 2020.
...
Active Directory groups have been analyzed. 0 out of 43 groups (0%) have a manager assigned.

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Groups with Manager | 0 |
| Groups without Manager | 43 |
...
Active Directory groups have been analyzed. 0 out of 43 groups (0%) have SID History set.
...
Active Directory group objects have been analyzed. 0 out of 43 groups (0%) are distribution groups (email-only).
...
Active Directory group objects have been analyzed. 43 out of 43 groups (100%) are security groups (used for access control).
...
Active Directory group objects have been analyzed. 32 out of 43 groups (74.42%) are domain local groups (resources in local domain only).

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Domain Local Groups | 32 |
| Domain Local Percentage | 74.42% |
...
Active Directory group objects have been analyzed. 11 out of 43 groups (25.58%) are global groups (forest-wide usage).

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Global Groups | 11 |
| Global Percentage | 25.58% |
...
Active Directory group objects have been analyzed. 0 out of 43 groups (0%) are universal groups (forest-wide, stored in Global Catalog).

| Metric | Value |
| --- | --- |
| Total Groups | 43 |
| Universal Groups | 0 |
| Universal Percentage | 0% |
...
| --- | --- |
| Domain Controllers | OU=Domain Controllers,DC=child,DC=misoule02,DC=local |
...
| Server DNS Name | MiSouleDC03.child.misoule02.local |
...
Active Directory computer SPNs have been analyzed. 9 distinct service classes found across 22 SPNs.

| Metric | Value |
| --- | --- |
| Total SPNs | 22 |
| Distinct Service Classes | 9 |
| Computers with SPNs | 1 |
...
| ldap | 8 | 36.36% |
| HOST | 5 | 22.73% |
| RestrictedKrbHost | 2 | 9.09% |
| TERMSRV | 2 | 9.09% |
| Dfsr-12F9A27C-BF97-4787-9364-D31B6C55EB04 | 1 | 4.55% |
| DNS | 1 | 4.55% |
| E3514235-4B06-11D1-AB04-00C04FC2DCD2 | 1 | 4.55% |
| GC | 1 | 4.55% |
| RPC | 1 | 4.55% |
...
Active Directory computer SPN analysis found 0 unknown service classes out of 9 total.
...
Active Directory computer SPN host analysis found 6 SPNs with non-FQDN hosts out of 22 total.
...
| HOST/MiSouleDC03/CHILD | MiSouleDC03 |
| HOST/MiSouleDC03 | MiSouleDC03 |
| ldap/MiSouleDC03/CHILD | MiSouleDC03 |
| ldap/MiSouleDC03 | MiSouleDC03 |
...
Active Directory user SPN analysis found 1 SPNs across 5 user accounts.
...
Active Directory user objects have been analyzed. 2 out of 5 users (40%) are disabled.
...
Active Directory user objects have been analyzed. 0 out of 3 enabled users (0%) have not logged on in more than 90 days.
...
Active Directory user objects have been analyzed. 1 out of 3 enabled users (33.33%) have non-expiring passwords.

| Metric | Value |
| --- | --- |
| Total Users | 5 |
| Enabled Users | 3 |
| Enabled Users with Password Never Expires | 1 |
| Non-Expiring Percentage (of enabled) | 33.33% |
...
Active Directory user objects have been analyzed. 0 out of 5 users (0%) are configured for reversible password encryption behavior.
...
Active Directory user objects have been analyzed. 0 out of 5 users (0%) are configured for Kerberos delegation.
...
Active Directory user objects have been analyzed. 0 out of 5 users (0%) are configured to use DES-only Kerberos encryption.
...
Active Directory user objects have been analyzed. 0 out of 5 users (0%) do not require Kerberos pre-authentication.
...
Active Directory user objects have been analyzed. 1 out of 3 enabled users (33.33%) have never logged on.
...
| Never Logged In Percentage (of enabled) | 33.33% |
...
Active Directory user objects have been analyzed. 2 out of 5 users (40%) do not require a password.
...
| Password Not Required Percentage | 40% |
...
Active Directory user objects have been analyzed. 0 out of 5 users (0%) have workstation logon restrictions configured.
...
Active Directory users have been analyzed. 2 out of 5 users (40%) have AdminCount set to 1.

| Metric | Value |
| --- | --- |
| Total Users | 5 |
| Users with AdminCount = 1 | 2 |
| AdminCount Percentage | 40% |
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have a primaryGroupId other than 513 (Domain Users).

| Metric | Value |
| --- | --- |
| Total Users | 5 |
| Users with PrimaryGroupId = 513 | 5 |
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have SID History set.
...
Active Directory users have been analyzed. 1 out of 5 users (20%) have one or more SPNs configured.
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have the Manager attribute populated.
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have the HomeDirectory attribute populated.
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have the ProfilePath attribute populated.
...
Active Directory users have been analyzed. 0 out of 5 users (0%) have the ScriptPath attribute populated.
...
Active Directory users have been analyzed. 5 out of 5 users (100%) are located in container paths such as CN=Users instead of OUs.

| Metric | Value |
| --- | --- |
| Total Users | 5 |
| Users in CN=Users | 5 |
| Users in Container Paths | 5 |
| Container Percentage | 100% |
...
Active Directory users have been analyzed. 0 out of 5 users (0%) match common service account naming patterns.
...
Cannot bind parameter 'Date'. Cannot convert value "134318069629011788" to type "System.DateTime". Error: "String '134318069629011788' was not recognized as a valid DateTime."
...
Cannot bind parameter 'Date'. Cannot convert value "0" to type "System.DateTime". Error: "String '0' was not recognized as a valid DateTime."
