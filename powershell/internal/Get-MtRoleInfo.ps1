...
$script:MtRoles = @{
    ...
    'PurviewWorkloadContentAdministrator' = [MtRoleDefinition]::new('3f04f91a-4ad7-4bd3-bcfa-49882ea1a88a', $false)
    'PurviewWorkloadContentReader' = [MtRoleDefinition]::new('e07494ad-1654-4dd2-922e-6f81a71bf00f', $false)
    'PurviewWorkloadContentWriter' = [MtRoleDefinition]::new('02d5655b-c1cf-4e5f-98da-5fb919085bf6', $false)
