function Test-MtAdUserScriptPathCount {
    ...
    Write-Verbose "Starting Test-MtAdUserScriptPathCount"
    ...
    Write-Verbose "Filtering/counting user script path count"
    ...
    Write-Verbose "Completed Test-MtAdUserScriptPathCount"
