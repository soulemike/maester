function Test-MtAdComputerSpnUnknownCount {
    ...
    may indicate custom applications, misconfigurations, or potentially malicious services.

    .EXAMPLE
    Test-MtAdComputerSpnUnknownCount

    Returns $true if SPN data is accessible, $false otherwise.
    The test result includes the count of unidentified service classes.

    .LINK
    https://maester.dev/docs/commands/Test-MtAdComputerSpnUnknownCount
    #>
    [CmdletBinding()]
    [OutputType([bool])]
    param()
